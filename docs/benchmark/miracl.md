...
| 总查询数 | 11076 |
| 索引吞吐 | 1507 doc/s |
| 纯 BM25 搜索延迟 | 83.88 ms/query |
| +桥扩展搜索延迟 | 155.97 ms/query |
| 总耗时 | 4909s (81.8 min) |
...
|------|---------|--------|------|-----------|-------------|
| ar | 0.4320 | 0.3918 | -0.0402 | 246.72 | 195.85 |
| bn | 0.6890 | 0.6539 | -0.0351 | 101.44 | 239.53 |
| de | 0.3714 | 0.3348 | -0.0366 | 32.02 | 76.89 |
| en | 0.4790 | 0.4853 | +0.0063 | 84.97 | 252.34 |
| es | 0.2286 | 0.1887 | -0.0400 | 103.48 | 185.06 |
| fa | 0.3536 | 0.3415 | -0.0121 | 101.56 | 111.21 |
| fi | 0.6329 | 0.5839 | -0.0491 | 120.32 | 265.07 |
| fr | 0.3921 | 0.3858 | -0.0064 | 48.18 | 86.08 |
| hi | 0.5225 | 0.4416 | -0.0808 | 37.40 | 68.54 |
| id | 0.4411 | 0.4203 | -0.0208 | 54.95 | 162.54 |
| ja | 0.5871 | 0.5695 | -0.0176 | 100.27 | 225.55 |
| ko | 0.5250 | 0.4449 | -0.0801 | 25.45 | 43.84 |
| ru | 0.5687 | 0.5450 | -0.0237 | 129.23 | 400.66 |
| sw | 0.5029 | 0.4146 | -0.0883 | 84.62 | 142.62 |
| te | 0.1571 | 0.0785 | -0.0786 | 100.01 | 126.02 |
| th | 0.6424 | 0.5635 | -0.0789 | 112.64 | 155.70 |
| yo | 0.6033 | 0.5750 | -0.0283 | 17.87 | 31.18 |
| zh | 0.5226 | 0.5073 | -0.0153 | 8.69 | 38.75 |
| **平均** | **0.4806** | **0.4403** | **-0.0403** | 83.88 | 155.97 |
...
| #50 | MCINext/Hakim-small | 0.4488 |
| #51 | BakaSearch（+桥扩展） | 0.4403 ← |
